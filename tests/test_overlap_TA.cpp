...
TEST_CASE("Overlap") {
    ...
    nwx_TA::Fill2DFunctor<TA::TArrayD::value_type, libint2::Operator::overlap> fill_a(LIBasis_sets, factory);
    nwx_TA::Fill2DFunctor<TiledArray::TSpArrayD::value_type, libint2::Operator::overlap> fill_b(LIBasis_sets, factory);
