...
function(cppyy_make_python_package _cmpp_target)
    ...
    if("${_cmpp_OUTPUT_DIR}" STREQUAL "")
        set(_cmpp_OUTPUT_DIR "${CMAKE_BINARY_DIR}/Integrals")
    endif()
    ...
    set(_cmpp_file "${_cmpp_file}cppyy.include(\"${libchemist_SOURCE_DIR}/include/integrals/integrals.hpp\")\n")
    set(_cmpp_file "${_cmpp_file}\ncppyy.load_library(\"${CMAKE_BINARY_DIR}/${_cmpp_lib}\")\n\n")
    set(_cmpp_file "${_cmpp_file}from cppyy.gbl import integrals\n")
    #Write it out
