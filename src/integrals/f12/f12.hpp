...
// /** @brief Namespace for derived integral types needed in explicitly
// correlated
//  *         theories.
//  */
...
// DECLARE_MULTICENTER_STG(correlation_factor_squared_,
// CorrelationFactorSquared); DECLARE_MULTICENTER_STG(dfdr_squared_,
// dfdrSquared); DECLARE_MULTICENTER_STG(gr, GR);
