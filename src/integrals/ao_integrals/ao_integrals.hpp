...
// using op_type = chemist::qm_operator::OperatorBase;
...
// EXTERN_AOI<braket<aos, op_type, aos>>;
// EXTERN_AOI<braket<aos, op_type, aos_squared>>;
// EXTERN_AOI<braket<aos_squared, op_type, aos_squared>>;
