...
namespace integrals {
    ...
    template<typename element_type>
    sde::type::result_map Yukawa3CIntDirect<element_type>::run_(sde::type::input_map inputs,
                                                                sde::type::submodule_map submods) const {
        using builder_type = nwx_TA::FillNDFunctor<tile_type<element_type>, libint2::Operator::yukawa, 3>;
        using bfactory_type = nwx_TA::BuilderFactory<tile_type<element_type>, libint2::Operator::yukawa, 3>;
    ...
    template<typename element_type>
    sde::type::result_map Yukawa4CIntDirect<element_type>::run_(sde::type::input_map inputs,
                                                                sde::type::submodule_map submods) const {
        using builder_type = nwx_TA::FillNDFunctor<tile_type<element_type>, libint2::Operator::yukawa, 4>;
        using bfactory_type = nwx_TA::BuilderFactory<tile_type<element_type>, libint2::Operator::yukawa, 4>;
        using direct_type = DirectTile<tile_type<element_type>, builder_type>;
        using tensor = TA::DistArray<direct_type, TA::SparsePolicy>;
