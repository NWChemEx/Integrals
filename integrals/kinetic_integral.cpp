...
namespace integrals {
    ...
    sde::type::result_map KineticInt<element_type>::run_(sde::type::input_map inputs,
        ...
        nwx_libint::LibintFactory<2, libint2::Operator::kinetic> factory(max_nprim, max_l, thresh, deriv);
        nwx_TA::Fill2DFunctor<typename tensor::value_type, libint2::Operator::kinetic> fill(LIBasis_sets, factory);

        auto T = TiledArray::make_array<TiledArray::TSpArrayD>(world, trange, fill);
