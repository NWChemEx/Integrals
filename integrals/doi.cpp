...
namespace integrals {
    ...
    DOInt<element_type>::DOInt() : sde::ModuleBase(this) {
        ...
        satisfies_property_type<doi_type>();
    ...
    sde::type::result_map DOInt<element_type>::run_(sde::type::input_map inputs,
        ...
        auto [bra, ket, deriv] = doi_type::unwrap_inputs(inputs);
        ...
        auto fill = nwx_TA::Fill4DFunctor<typename tensor::value_type, libint2::Operator::delta>();
        ...
        auto rv = results();
        return doi_type::wrap_results(rv, I);
    }
