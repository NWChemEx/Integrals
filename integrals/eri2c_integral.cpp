...
namespace integrals {
    ...
    ERI2CInt<element_type>::ERI2CInt() : sde::ModuleBase(this) {
        ...
        satisfies_property_type<eri2c_type>();
    ...
    sde::type::result_map ERI2CInt<element_type>::run_(sde::type::input_map inputs,
        ...
        auto [bra, ket, deriv] = eri2c_type::unwrap_inputs(inputs);
        ...
        nwx_libint::LibintFactory<2, libint2::Operator::coulomb> factory(max_nprim, max_l, thresh, deriv);
        nwx_TA::Fill2DFunctor<typename tensor::value_type, libint2::Operator::coulomb> fill(LIBasis_sets, factory);
        ...
        auto rv = results();
        return eri2c_type::wrap_results(rv, I);
    }
