...
void load_modules(sde::ModuleManager& mm,
    ...
    mm.at("STG2").change_input("STG Exponent",stg_exponent);
    ...
    mm.at("STG3").change_input("STG Exponent",stg_exponent);
    ...
    mm.at("STG4").change_input("STG Exponent",stg_exponent);

    mm.add_module("Yukawa2", std::make_shared<Yukawa2>());
    mm.at("Yukawa2").change_input("Tile Size",tile_size);
    mm.at("Yukawa2").change_input("STG Exponent",stg_exponent);
    ...
    mm.at("Yukawa3").change_input("STG Exponent",stg_exponent);
