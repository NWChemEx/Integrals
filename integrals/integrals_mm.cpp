...
void load_modules(sde::ModuleManager& mm, const std::size_t tile_size,
                  const detail_::implementation_type& impl, const double screen,
    ...
    mm.add_module("DOI", std::make_shared<DOI>(impl));
    mm.at("DOI").change_input("Tile Size", tile_size);
