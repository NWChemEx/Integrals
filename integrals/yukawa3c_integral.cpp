...
namespace integrals {
    ...
    Yukawa3CInt<element_type>::Yukawa3CInt() : sde::ModuleBase(this) {
        ...
        satisfies_property_type<yukawa3c_type>();
    ...
    sde::type::result_map Yukawa3CInt<element_type>::run_(sde::type::input_map inputs,
        ...
        auto [bra, ket1, ket2, deriv, stg_exponent] = yukawa3c_type::unwrap_inputs(inputs);
        ...
        nwx_libint::LibintFactory<3, libint2::Operator::yukawa> factory(max_nprim, max_l, thresh, deriv);
        ...
        auto rv = results();
        return yukawa3c_type::wrap_results(rv, I);
    }
