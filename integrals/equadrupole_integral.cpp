...
namespace integrals {
    ...
    EQuadrupoleInt<element_type>::EQuadrupoleInt() : sde::ModuleBase(this) {
        ...
        satisfies_property_type<eQuadrupole_type>();
    ...
    sde::type::result_map EQuadrupoleInt<element_type>::run_(sde::type::input_map inputs,
        ...
        auto [bra, ket, deriv, origin] = eQuadrupole_type::unwrap_inputs(inputs);
        ...
        auto fill = nwx_TA::FillMultipoleFunctor<typename tensor::value_type, libint2::Operator::emultipole2>();
        ...
        auto rv = results();
        return eQuadrupole_type::wrap_results(rv, S);
    }
