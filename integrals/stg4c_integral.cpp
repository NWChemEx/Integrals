...
namespace integrals {
    ...
    STG4CInt<element_type>::STG4CInt() : sde::ModuleBase(this) {
        ...
        satisfies_property_type<stg4c_type>();
    ...
    sde::type::result_map STG4CInt<element_type>::run_(sde::type::input_map inputs,
        ...
        nwx_libint::LibintFactory<4, libint2::Operator::stg> factory(max_nprim, max_l, thresh, deriv);
        factory.stg_exponent = stg_exponent;
        nwx_TA::Fill4DFunctor<typename tensor::value_type, libint2::Operator::stg> fill(LIBasis_sets, factory);
        ...
        auto rv = results();
        return stg4c_type::wrap_results(rv, I);
    }
