...
TEST_CASE("Cauchy-Schwarz") {
    ...
    REQUIRE(chemist::ta_helpers::allclose(X, TensorType(X.world(), X.trange(), corr)));
    ...
    REQUIRE(chemist::ta_helpers::allclose(X_core, TensorType(X_core.world(), X_core.trange(), corr)));
}
