...
if [ "${USE_CLANG}" = true ]; then
   docker build -t ghcr.io/nwchemex-project/release_integrals:clang-latest -f release.Dockerfile .
   docker push ghcr.io/nwchemex-project/release_integrals:clang-latest
else
   docker build -t ghcr.io/nwchemex-project/release_integrals:gcc-latest -f release.Dockerfile .
   docker push ghcr.io/nwchemex-project/release_integrals:gcc-latest
fi
