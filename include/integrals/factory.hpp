...
namespace integrals {
     ...
     *  basis sets, shells, properties, and the like. Ultimately a library is used to
     *  calculate the corresponding integrals. Currently we just use Libint2 but in
     *  future it is possible that we might have multiple libraries to choose from. 
     *  In any case Libint2 has its own expectations for data types and the like.
     *
    ...
    class Factory {
        private:
            ...
            LI_basis lbs4;
        public:
            Factory(property prop, NWX_basis bs1, NWX_basis bs2, NWX_basis bs3, NWX_basis bs4);
